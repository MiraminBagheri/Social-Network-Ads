...
classifier = RandomForestClassifier(n_estimators = 10, criterion = 'gini', max_depth= 5, max_features= 'auto', min_samples_leaf= 1, min_samples_split= 2, random_state = 0)
...
output= [['Random Forest', 'Yes', accuracies.mean()*100, accuracies.std()*100, accuracy_score(y_test, y_pred)]]
