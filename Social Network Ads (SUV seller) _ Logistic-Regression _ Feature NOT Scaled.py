...
classifier = LogisticRegression(C= 0.1, max_iter= 100, multi_class= 'ovr', penalty= 'l2', solver= 'newton-cg',random_state = 0)
...
output= [['Logistic Regression', 'No', accuracies.mean()*100, accuracies.std()*100, accuracy_score(y_test, y_pred)]]
