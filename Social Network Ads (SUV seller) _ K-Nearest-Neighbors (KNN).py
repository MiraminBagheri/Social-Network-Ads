...
classifier = KNeighborsClassifier(n_neighbors = 7, metric = 'minkowski', p = 3, weights='uniform')
...
output= [['KNN', 'Yes', accuracies.mean()*100, accuracies.std()*100, accuracy_score(y_test, y_pred)]]
